...
public class LinkedListBasedQueueSinglePointer {
    ...
    public LinkedListBasedQueueSinglePointer() {
        first = null;
        size = 0;
    }

    public LinkedListBasedQueueSinglePointer(int element) {
    ...
    static void main() {
        int choice;
        LinkedListBasedQueueSinglePointer queue = new LinkedListBasedQueueSinglePointer();
